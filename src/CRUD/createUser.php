...
try {
$query = "INSERT INTO enrollments(studentNo,name,surname,subject,unitCode,session,classSection,expiryDate) VALUES (:num,:nam,:surname,:subject,:code,:sess,:sec,:tim)";
